      ...
      <main className="flex flex-1 w-full flex-col items-center justify-center text-center px-4 sm:mt-28 mt-20">
        <h1 className="mx-auto max-w-4xl font-display text-5xl font-bold tracking-normal text-white sm:text-7xl">
          ...
          <span className="relative whitespace-nowrap text-indigo-500">
            ...
            <span className="relative">CRUD</span>
          </span>
        </h1>
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="border rounded-2xl py-1 px-4 text-slate-500 text-sm my-10 hover:scale-105 transition duration-300 ease-in-out"
        >
          Inspired by the amazing
          <span className="font-semibold"> Fazt Code</span>
        </a>
      </main>
